...
import { truncateWalletString, NetworkParams } from 'utils';
    ...
    <>
      {
        ...
        <Container className={classes.root}>
            ...
            <div className={classes.stateRoot}>
              <div className={classes.content}>
                <div className={`${classes.item} ${classes.rightLine}`}>
                  <h3 
                    onClick={() => window.open(`${NetworkParams?.[spaceInfo.chainId]?.blockExplorerUrls[0]}/address/${spaceInfo.nftAddr}`)}>
                    {truncateWalletString(spaceInfo.nftAddr)}
                  </h3>
                  <p>Power Contract</p>
                </div>
                <div className={`${classes.item} ${classes.rightLine}`}>
                  <h3>{spaceInfo.overview.totalPower} entities</h3>
                  <p>Total Power</p>
                </div>
                <div className={`${classes.item} ${classes.rightLine}`}>
          ...
          <div className={classes.section}>
            <ActiveProposals spaceId={spaceId}/>
          </div>
        </Container>
      }
    </>
