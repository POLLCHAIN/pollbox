...
const ProposalDetail = (props: any) => {
  ...
  useEffect(() => {
    if (account && chainId && proposalInfo) {
      getNFTBalance(account, proposalInfo.spaceInfo.nftAddr, proposalInfo.spaceInfo.nftType, chainId, library?.getSigner())
        .then((balance) => {
              ...
              <div className={classes.contentBody}>
                <div className={classes.productWrapper}>
                            ...
                            proposalInfo.voteSummary.map((info: any, index2: any) => (
                              <div className={classes.progressState} key={index2}>
                                <div className="labels">
                                  <p>{info.choice}</p>
                                  <p>{info.totalPower} entities Voting ({formatNum(info.totalPower * 100 / proposalInfo.totalPower)}%)</p>
                                </div>
                  ...
                  <div className={classes.cardState}>
                    ...
                    <span>
                      <p>Total Votes</p>
                      <p>{proposalInfo.totalPower} entities</p>
                    </span>
                    <span>
                      <p>Unique Voters</p>
